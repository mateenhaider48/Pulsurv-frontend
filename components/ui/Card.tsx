  ...
  return (
    ...
    >
      ...
      >
        {Icon && (
          <Icon
            className={`${iconSize}  ${size === "medium" ? "text-custom-secondary" : size === "xl" ? (index == 1 ? "text-custom-dark-grey/90 group-hover:text-custom-white" : "") : size === "lg" ? "text-custom-primary group-hover:text-custom-white" : size === "sm"? "text-custom-secondary":" text-custom-secondary group-hover:text-custom-white"} group-hover:text-custom-white transition-colors duration-300`}
          />
        )}
      </div>
