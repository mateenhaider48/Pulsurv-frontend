...
export const Card = ({
  ...
  return (
    ...
    >
      ...
      <p
        className={`font-semibold ${size === "small" ? "text-[10px] sm:text-sm text-center mt-2" : size === "medium" ? "mt-2 text-sm sm:text-base sm:mt-2 group-hover:text-custom-secondary" : size === "xl" ? "text-sm text-center sm:mt-4" : size === "lg" ? "text-sm sm:text-base text-center mt-2" : "mt-4"} leading-normal  text-custom-dark-grey/90 px-4 `}
      >
        {title}
      </p>

      <p
        className={`leading-normal  ${size === "small" ? "text-[10px] sm:text-sm text-center" : size === "medium" ? "sm:mt-2 text-[10px] sm:text-sm group-hover:text-custom-dark-grey" : size === "xl" ? "text-sm text-center sm:mt-2" : size === "lg" ? "text-[10px] sm:text-base text-center sm:mt-2" : "text-sm mt-4"} text-custom-dark-grey/60 px-4 ${textSize}`}
      >
        {text}
      </p>
    </div>
