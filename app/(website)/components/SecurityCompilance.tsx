import { accessibility, androidIcon, GDRP, RecipientIcon, SecurityIcon } from "@/components/svg-icons";
  ...
  return (
    <div className="w-full h-[700px] bg-custom-white absolute top-[6108px]">
      ...
      <div className="flex items-center justify-center mt-6 gap-4">
        <div>
            <p className="text-2xl font-700 font-bold leading-normal text-custom-dark-grey/90 text-center">256-bit</p>
            <p className="text-sm leading-tight text-center text-custom-dark-grey/50">Encryption</p>
        </div>
        <div className="h-12 w-[1px] bg-custom-dark-grey/40"></div>
         <div>
            <p className="text-2xl font-700 font-bold leading-normal text-custom-dark-grey/90 text-center">99.9%</p>
            <p className="text-sm leading-tight text-center text-custom-dark-grey/50">Uptime SLA</p>
        </div>
        <div className="h-12 w-[1px] bg-custom-dark-grey/40"></div>
         <div>
            <p className="text-2xl font-700 font-bold leading-normal text-custom-dark-grey/90 text-center">WCAG 2.1</p>
            <p className="text-sm leading-tight text-center text-custom-dark-grey/50">Accessibility</p>
        </div>
        <div className="h-12 w-[1px] bg-custom-dark-grey/40"></div>
         <div>
            <p className="text-2xl font-700 font-bold leading-normal text-custom-dark-grey/90 text-center">ISO 27001</p>
            <p className="text-sm leading-tight text-center text-custom-dark-grey/50">Certified</p>
        </div>
      </div>
      </div>
    </div>
