...
export default function PulsurvSurveys() {
  ...
  return (
    <div className="bg-gradient-to-b from-[#F4F9FF] to-[#F4F9FF] min-h-screen">
      <div className="flex flex-col md:flex-row">
        <div className="w-full mx-auto flex flex-col justify-center py-10  max-w-3xl ">
          ...
          <p className="text-custom-dark-grey/60 text-sm sm:text-base tracking-tight sm:leading-normal max-w-md mt-4 sm:mt-5">
            Create, distribute, and analyze short surveys to gather real-time
            feedback from customers and internal teams.
          </p>
          <p className="text-custom-dark-grey/60 text-sm  sm:text-base tracking-tight sm:leading-normal max-w-md">
          ...
          <div className="flex flex-wrap mt-4 sm:mt-8 sm:mt-10 gap-6 sm:gap-8">
            <div className="flex gap-2 items-center">
              ...
              />
              <p className="text-xs sm:text-sm text-custom-dark-grey/90 leading-5">
        ...
        <div className="relative ml-auto md:w-1/3 bg-custom-secondary rounded-b-none rounded-bl-2xl md:rounded-bl-3xl rounded-br-2xl min-h-screen flex-shrink-0">
          <img
