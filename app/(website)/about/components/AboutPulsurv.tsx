  ...
  return (
    <div className='bg-gradient-to-b from-[#FFFFFF] to-[#F9FAFB] '>
      <div className='flex flex-col md:flex-row items-center justify-between my-5'>
        ...
        <p className="text-base leading-normal text-left mx-5 sm:mx-7 md:mx-10 text-custom-dark-grey/40">
      ...
      <div>
        <img src="/images/aboutImg.png" className="w-1/2  mx-25 lg:mx-75  mt-2 p-3  rotate-0 opacity-100 rounded-sm"/>
      </div>
      </div>
    </div>
  )
